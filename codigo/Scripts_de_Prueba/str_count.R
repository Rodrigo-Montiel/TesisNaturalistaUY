# ESTE SCRIPT ES PARA VER LAS DIFERENCIAS ENTRE USAR LA FUNCION STR_COUNT Y NO, 
# PARA SELECCIONAR AQUELLOS NOMBRES CIENTIFICOS CON DOS PALAGRAS

#CONTRIBUCIONES NATUY - CANTIDAD DE REGISTROS Y ESPECIES------------------------

## Cantidad de  registradas sin str_count
...
#### Cantidad de Especies registradas con str_count
...
## Filtrado de registros: GI + Nivel Especie con str_count
